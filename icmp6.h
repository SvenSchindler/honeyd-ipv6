...
#define ICMP6_NODE_INFORMATION_REPLY    140

struct ni_message {
    struct icmp6_hdr    ni_hdr;
    uint32_t            ni_nonce[2];
    /* could be followed by data */
};

#define ni_type         ni_hdr.icmp6_type
#define ni_code         ni_hdr.icmp6_code
#define ni_qtype        ni_hdr.icmp6_data16[0]
#define ni_flags        ni_hdr.icmp6_data16[1]
