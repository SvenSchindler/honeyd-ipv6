...
int random_create_ipv6_template(const char *template_name, struct addr* attacker_addr, const struct interface *inter,float randomipv6_percentage,unsigned long long max_random_ipv6_hosts,FILE * logfp);
